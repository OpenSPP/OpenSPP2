...
"""Tests for IBR DCI signature verification middleware."""
...
class TestIBRSignatureMiddleware(IBRClientCommon):
    """Test cases for IBR signature verification middleware."""

    def setUp(self):
        """Set up test fixtures for each test method."""
        super().setUp()

        # Create a test IBR sender in the registry
    ...
    async def _verify_signature(self, envelope_data):
        """Helper to call the verify_ibr_signature function.
        ...
        """
        from odoo.addons.spp_dci_client_ibr.middleware.signature import (
            verify_ibr_signature,
        )
        ...
        return await verify_ibr_signature(envelope, self.env)
    ...
    def test_verify_logs_success(self):
        ...
        with patch("odoo.addons.spp_dci_client_ibr.middleware.signature._logger") as mock_logger:
            # Run async verification
            import asyncio
    ...
    def test_verify_with_different_message_types(self):
        """Test verification with different IBR event types."""
        import asyncio
    ...
    def test_verify_sender_lookup_uses_sudo(self):
        ...
        # the current user doesn't have read access to spp.dci.ibr.sender
