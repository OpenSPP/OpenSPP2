...
class TestAggregationService(AggregationTestCase):
    """Tests for spp.aggregation.service main entry point."""
...
class TestAggregationServiceAccessControl(AggregationTestCase):
    ...
    def test_access_rule_aggregate_only(self):
        ...
        # Run as test user
        service = self.env["spp.aggregation.service"].with_user(self.test_user)
...
class TestAggregationServicePublicUser(AggregationTestCase):
    ...
    def test_compute_aggregation_explicit_scope_as_public_user(self):
        ...
        service = self.env["spp.aggregation.service"].with_user(self.public_user)
