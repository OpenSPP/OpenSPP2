# Integration Tests for spp_aggregation
...
- Install both `spp_aggregation` and `spp_mis_demo_v2`
...
- Install only `spp_aggregation` with minimal dependencies
...
- `spp_aggregation/README.md` - Module overview and architecture
