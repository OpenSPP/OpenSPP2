...
class AggregationCacheService(models.AbstractModel):
    ...
    spp.aggregation.cache.entry with TTL-based expiration.
    ...
    def get_cached_result(self, scope, statistics=None, group_by=None):
        ...
        :param scope: spp.aggregation.scope record, ID, or dict
...
class AggregationCacheEntry(models.Model):
    ...
    _name = "spp.aggregation.cache.entry"
    ...
    def cron_cleanup_expired(self):
        ...
        :rtype: int
        """
        return self.env["spp.aggregation.cache"].cleanup_expired()
