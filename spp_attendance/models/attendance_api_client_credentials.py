...
class AttendanceApiClientCredential(models.Model):
    ...
    _client_secret_uniq = models.Constraint("unique(client_secret)", "Client Secret must be unique !")
    ...
    def show_credentials(self):
        ...
        if not self.show_button_clicked:
            ...
            form_id = self.env.ref("spp_attendance.view_spp_attendance_api_client_credential_form").id
