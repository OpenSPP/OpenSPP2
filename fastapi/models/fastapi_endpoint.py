...
class FastapiEndpoint(models.Model):
    ...
    description: str = fields.Text(help="A short description of the API. It can use Markdown")
    ...
    def _make_routing_rule(self, options=None):
        ...
        return self._endpoint_registry.make_rule(key, route, options, routing, endpoint_hash)
