...
class TestAnalyticsApi(SimulationApiTestCase):
    """Test analytics endpoint schemas and logic."""

    def test_aggregation_scope_request_defaults(self):
        """Test AnalyticsScopeRequest schema defaults."""
        from ..schemas.analytics import AnalyticsScopeRequest

        scope = AnalyticsScopeRequest()
    ...
    def test_aggregation_scope_request_with_values(self):
        """Test AnalyticsScopeRequest with explicit values."""
        from ..schemas.analytics import AnalyticsScopeRequest
    ...
    def test_aggregation_response_no_breakdown(self):
        """Test AnalyticsResponse without breakdown."""
        from ..schemas.analytics import AnalyticsResponse
    ...
    def test_dimensions_list_response_schema(self):
        ...
        from ..schemas.analytics import DimensionInfo, DimensionsListResponse
