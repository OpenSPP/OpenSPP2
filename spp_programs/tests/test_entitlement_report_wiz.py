...
class TestEntitlementReportWiz(Common):
    def setUp(self):
        super().setUp()
        self._test_record = self.env["spp.entitlement.inkind.report.wizard"].create(
            {
    ...
    def test_02_generate_report(self):
        ...
        self.assertEqual(res["res_model"], "spp.entitlement.inkind", "Should return correct model!")
        self.assertEqual(
            res["domain"],
