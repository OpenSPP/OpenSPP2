...
class SPPDuplicateProgramMembership(models.Model):
    _inherit = ["mail.thread", "mail.activity.mixin"]
    _name = "spp.program.membership.duplicate"
    _description = "Program Membership duplicate"
    _order = "id desc"

    beneficiary_ids = fields.Many2many("spp.program.membership", string="Beneficiaries")
