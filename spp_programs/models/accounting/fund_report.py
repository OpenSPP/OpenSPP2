...
class ProgramFundReport(models.Model):
    ...
    def _select(self):
        select_str = """
            WITH trans AS (
                ...
                FROM spp_entitlement b1
                    LEFT JOIN spp_cycle b2 on b2.id = b1.cycle_id
                        LEFT JOIN spp_program b3 on b3.id = b2.program_id
    ...
    def init(self):
        ...
        # nosemgrep: odoo-sql-injection-fstring - Using self._table (internal model attribute), not user input
        self.env.cr.execute(
