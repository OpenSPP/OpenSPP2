...
class SPPDefaultEntitlementManagerCustom(models.Model):
    """
    SPPDefaultEntitlementManagerCustom adds the configured card number in
    ...
    def prepare_entitlements(self, cycle, beneficiaries):
        ...
        if entitlements:
            self.env["spp.entitlement"].create(entitlements)
