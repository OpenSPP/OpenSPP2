...
- fix: import the tours' stepUtils from the Odoo 19 path
  @web_tour/tour_utils and drop the pre-18 ``test`` tour key that Odoo
  19 rejects, so web.assets_tests loads without module loader errors and
