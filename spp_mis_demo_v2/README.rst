...
- feat: demo GIS reports, statistics, API client data and debug-layer
  coverage aligned with the GIS report disaggregation and OGC
  processes/incidents APIs (re-land from #76).
