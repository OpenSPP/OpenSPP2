...
"""Tests for SR DCI signature verification middleware."""
...
class TestSRSignatureMiddleware(SRClientCommon):
    """Test cases for SR signature verification middleware."""

    def setUp(self):
        """Set up test fixtures for each test method."""
        super().setUp()

        # Create a test SR sender in the registry
    ...
    async def _verify_signature(self, envelope_data):
        """Helper to call the verify_sr_signature function.
        ...
        """
        from odoo.addons.spp_dci_client_sr.middleware.signature import (
            verify_sr_signature,
        )
    ...
    def test_verify_logs_success(self):
        ...
        with patch("odoo.addons.spp_dci_client_sr.middleware.signature._logger") as mock_logger:
            # Run async verification
            import asyncio
    ...
    def test_verify_with_different_message_types(self):
        """Test verification with different SR event types."""
        import asyncio
    ...
    def test_verify_sender_lookup_uses_sudo(self):
        ...
        # the current user doesn't have read access to spp.dci.sr.sender
