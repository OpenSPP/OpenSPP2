        ...
        cls._test_group = cls._create_registrant(
            {
                ...
                "group_membership_ids": [
                    ...
                    Command.create({"individual": cls._test_individual_2.id}),
                    Command.create({"individual": cls._test_individual_3.id}),
                    Command.create({"individual": cls._test_individual_4.id}),
                ],
            }
        )
