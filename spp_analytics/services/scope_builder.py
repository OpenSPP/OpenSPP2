...
The scope dictionaries can be passed directly to spp.analytics.service.compute_aggregation()
and will be resolved by spp.analytics.scope.resolver.
"""
...
def build_area_scope(area_id, include_children=True):
    ...
    Example:
        ...
        >>> result = env['spp.analytics.service'].compute_aggregation(scope=scope)
    """
    return {
        "scope_type": "area",
        "area_id": area_id,
