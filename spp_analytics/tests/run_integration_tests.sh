...
#
# Run integration tests for spp_analytics with MIS demo data.
#
# This script installs both spp_analytics and spp_mis_demo_v2 to enable
# comprehensive integration testing with realistic demo data.
#
# Usage:
#   ./spp_analytics/tests/run_integration_tests.sh
#
# Options:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --verbose)
            ...
            ;;
        --help)
            echo "Run integration tests for spp_analytics"
            echo ""
...
if [ $UNIT_ONLY -eq 1 ]; then
    echo "=========================================="
    echo "Running UNIT tests for spp_analytics"
    echo "=========================================="
    echo ""
    ...
    echo "=========================================="
    echo "Running INTEGRATION tests for spp_analytics"
    echo "=========================================="
    echo ""
    echo "This will:"
    echo "  - Install spp_analytics + spp_mis_demo_v2"
