...
class TestCacheService(AggregationTestCase):
    ...
    def setUpClass(cls):
        ...
        # Create a test scope
        cls.test_scope = cls.env["spp.analytics.scope"].create(
            {
    ...
    def test_cache_disabled_for_spatial_queries(self):
        ...
        spatial_scope = self.env["spp.analytics.scope"].create(
            {
    ...
    def test_cache_expiration(self):
        ...
        with patch("odoo.addons.spp_analytics.models.service_cache.fields.Datetime.now") as mock_now:
    ...
    def test_invalidate_all(self):
        ...
        scope2 = self.env["spp.analytics.scope"].create(
            {
                "name": "Test Scope 2",
                "scope_type": "area",
    ...
    def test_cleanup_expired(self):
        ...
        entry = self.env["spp.analytics.cache.entry"].search([], limit=1)
